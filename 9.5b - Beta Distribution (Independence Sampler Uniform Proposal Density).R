...
# PROGRAM   9.5b - Beta Distribution (Independence Sampler Uniform Proposal Density)
...
#       y_{t+1} = \epsilon_t  where \epsilon_t ~ U[0,1]
#
#
#     Section 1:
...
set.seed(12345)
MH_Output <- betaMH(burnin + mcmc, 2, 4, start = 0.5)
